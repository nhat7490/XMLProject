        ...
        <div class="footer">
            <div class="pagination">
                ...
                <c:if test="${currentPage lt 7}">
                    ...
                    <div class="pages">
                        <c:forEach var="i" begin="1" end="7">
                            <div class="page">
                                <a href="/tim-kiem?search=${searchValue}&pageNo=${i}">${i}</a>
                            </div>
                        </c:forEach>
                    </div>
                ...
                <c:if test="${currentPage ge 7}">
                    ...
                    <div class="prev">
                        <a href="/tim-kiem?search=${searchValue}&pageNo=${currentPage-1}">Trang Trước</a>
                    </div>
                    <div class="pages">
                    ...
                    <div class="next">
                        <a href="/tim-kiem?search=${searchValue}&pageNo=${currentPage+1}">Trang Sau</a>
                    </div>
